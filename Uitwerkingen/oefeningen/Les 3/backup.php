...
class Dier {
	...
	private $aantal_poten = 8;
	private $diersoort = "arachnochide";
	private $kleur = "zwart";
	private $aantalOgen = 16;
	private $dieet = "carnivoor";
	
	public function __construct($kleur, $aantal_poten) {
	...
	public function tonen() {
		echo "Dit is een {$this->kleur} dier met {$this->aantal_poten} poten.";
	}
}
